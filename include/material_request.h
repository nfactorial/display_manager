...
namespace ngen {
    namespace renderer {
        ...
        public:
            ...
            bool initialize(RequestProvider *owner, IMaterial *material);
        ...
        private:
            ...
            IMaterial *m_material;              //!< Material associated with this request
        ...
        inline IMaterial* MaterialRequest::getMaterial() const {
            return m_material;
        }
