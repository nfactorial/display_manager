...
namespace ngen {
    namespace renderer {
        ...
        //!
        //! A render layer represents a collection of materials that are to be drawn
        //! together. For example, opaque objects, transparent objects. Objects are
        //! grouped into their associated layers when they request rendering.
        //! When executed, all the queued render operations for the layer are processed.
        class RenderLayer {
        public:
            RenderLayer();
            ~RenderLayer();
            ...
            MaterialRequest* findRequest(IMaterial *material) const;
